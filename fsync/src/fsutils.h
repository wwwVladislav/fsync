...
typedef void (*fsdir_evt_handler_t)(fsdir_action_t, char const *);
...
void              fsdir_listener_free(fsdir_listener_t *);
bool              fsdir_listener_add_path(fsdir_listener_t *, char const *);
bool              fsdir_listener_reg_handler(fsdir_listener_t *, fsdir_evt_handler_t);
