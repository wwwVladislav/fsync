...
fostream_t          *frstream_factory_ostream(frstream_factory_t *pfactory, fuuid_t const *dst);        // src(ostream) ----> dst(istream)
fistream_t          *frstream_factory_istream(frstream_factory_t *pfactory, fuuid_t const *dst);        // dst(istream) <---- src(ostream)
